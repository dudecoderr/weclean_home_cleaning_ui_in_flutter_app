...
class Nov10to15ChartPage extends StatefulWidget {
  const Nov10to15ChartPage({Key? key}) : super(key: key);

  @override
  State<Nov10to15ChartPage> createState() => _Nov10to15ChartPageState();
}

class _Nov10to15ChartPageState extends State<Nov10to15ChartPage> {
  int selectedIndex = 0;
